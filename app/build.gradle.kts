plugins {
    ...
    alias(libs.plugins.ksp) // добавили плагин KSP
}

android {
    namespace = "com.example.wifi_analyzer"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.example.wifi_analyzer"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("commons-net:commons-net:3.11.1") // Для определения служб (FTP, etc.)
